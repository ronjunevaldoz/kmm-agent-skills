...
Usage:
  ...
  python3 update_design_system.py <project_root> --skill-root /path/to/kmp-agent-skills
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=None,
        help="Path to kmp-agent-skills repo (default: auto-detect from script location)",
    )
    parser.add_argument(
        "--diff",
        metavar="COMPONENT",
