...
`kmp-design-system` skill's own module convention, **not** universal.
...
- `kmp-design-system` — semantic tint tokens (`AppTheme.colors.X`) applied at the icon call site; `/kmp-generate-palette` for the token map itself
