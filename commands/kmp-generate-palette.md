# /kmp-generate-palette $ARGUMENTS
...
Examples:
```
/kmp-generate-palette primary=#1E3A5F secondary=#F0F0F0
/kmp-generate-palette primary=#1E3A5F accent=#E67E22 danger=#E74C3C --group-id com.example.app
/kmp-generate-palette --image brand_guide.png --count 4
```
