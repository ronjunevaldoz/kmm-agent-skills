# /kmm-sync-local-skills

Sync the latest `kmm-agent-skills` release into the local assistant skill bundles on this Mac:
...
```bash
bash /Users/ronvaldoz/Documents/kmm-agent-skills/scripts/sync-local-assistant-skills.sh
```

Dry run:

```bash
bash /Users/ronvaldoz/Documents/kmm-agent-skills/scripts/sync-local-assistant-skills.sh --dry-run
```
