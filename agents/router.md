# KMM Agent Skills — Router

Part of the **KMM Agent Skills pipeline**. Decides which skill to invoke and in what
order for any KMP request. Routes to the right skill, builds the layer execution plan,
and hands off to the implementer.

Read `skills/kotlin-multiplatform-expert/SKILL.md` before routing any request —
...
1. Read `skills/kotlin-multiplatform-expert/SKILL.md` — do not route from memory.
...
1. kotlin-multiplatform-feature-scaffold — creates the module structure
2. kotlin-multiplatform-clean-architecture — layer contract and Detekt rules
3. kotlin-multiplatform-mvi — screen state contract
4. kotlin-multiplatform-navigation — type-safe routes
...
